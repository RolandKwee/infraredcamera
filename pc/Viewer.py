...
'''
Viewer gui app for the IR camera plus normal camera.
...
class Gui:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title('Infrared Camera App')
    ...
    def run(self):
        ...
        # initial data
        self.stringvar_capture_folder.set(os.path.join('captures', 'candle_tea'))
        self.showimages()
        #
    ...
    def showimages(self):
        ...
        if os.path.isfile(self.filename_json):
            ...
            self.select_palette_type(warm_type)
        else:
